...
import pt.ruiandrade.formula.Variable;
...
class Driver {
	...
	public static void main(String[] args) throws Exception {
		...
		Formula f1 = (Formula) parser.parse().value;
		Formula f = new OrFormula(new AndFormula(new Variable("A"), new Variable("B")), new Variable("D"));
